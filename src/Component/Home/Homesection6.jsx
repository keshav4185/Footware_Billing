                    ...
                    <tbody className="divide-y divide-gray-50">
                        {[
                            ...
                            <tr key={idx} className="group hover:bg-blue-50/10 transition-colors">
                                ...
                                <td className="py-6 px-4 text-green-600 font-bold">₹{row.amount.toFixed(2)}</td>
                                <td className="py-6 px-4">
                                    <span className="px-3 py-1.5 text-[11px] font-bold rounded-full bg-green-50 text-green-600 border border-green-100 uppercase tracking-tight">Completed</span>
                                </td>
                                <td className="py-6 px-4">
                                    <span className="px-3 py-1.5 text-[11px] font-bold rounded-full bg-green-50 text-green-600 border border-green-100 flex items-center justify-center gap-1.5 uppercase tracking-tight">
                                ...
                                <td className="py-6 px-4">
                                    <div className="flex items-center justify-center gap-2">
                                        <button className="p-2.5 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-all shadow-sm hover:shadow-md active:scale-95">
                                            <Eye size={20} />
                                        </button>
                                        <button className="p-2.5 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all shadow-sm hover:shadow-md active:scale-95">
                                            <Printer size={20} />
                                        </button>
                                        <button className="p-2.5 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-all shadow-sm hover:shadow-md active:scale-95">
                                            <Trash2 size={20} />
                                        </button>
                                    </div>
                                </td>
