        ...
        <div className="min-h-screen bg-white font-inter relative overflow-hidden pb-32">
            ...
            <div className="pt-32 pb-20 px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    <div 
                        className="inline-flex items-center gap-2 px-4 py-2 bg-[#B564C3]/10 border border-[#B564C3]/20 text-[#B564C3] rounded-full text-xs font-black uppercase tracking-widest mb-8 shadow-sm"
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 space-y-12">
                ...
                <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_40px_rgb(79,70,229,0.08)] hover:border-indigo-100 transition-all duration-500 group relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        <div className="p-4 bg-[#3D0448]/10 text-[#3D0448] rounded-2xl shrink-0 group-hover:scale-110 group-hover:bg-[#3D0448] group-hover:text-white transition-all duration-500 shadow-sm">
                            <Database size={32} />
                        </div>
                        <div>
                            <h2 className="text-2xl font-black text-gray-900 mb-4 tracking-tight group-hover:text-[#3D0448] transition-colors">1. Information We Collect</h2>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3 bg-gray-50 p-4 rounded-xl">
                                    <ChevronRight className="text-[#3D0448] shrink-0 mt-0.5" size={18}/>
                ...
                <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_40px_rgb(168,85,247,0.08)] hover:border-purple-100 transition-all duration-500 group relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        <div className="p-4 bg-[#B564C3]/10 text-[#B564C3] rounded-2xl shrink-0 group-hover:scale-110 group-hover:bg-[#B564C3] group-hover:text-white transition-all duration-500 shadow-sm">
                            <Eye size={32} />
                        </div>
                        <div>
                            <h2 className="text-2xl font-black text-gray-900 mb-4 tracking-tight group-hover:text-[#B564C3] transition-colors">2. How We Use Your Information</h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="p-4 bg-[#B564C3]/5 rounded-xl text-gray-600 font-medium text-sm flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#B564C3] rounded-full"></div> Account & Login verification</div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-end md:items-center">
                        <div className="w-full md:w-3/4">
                            <h2 className="text-2xl font-black text-gray-900 mb-4 tracking-tight group-hover:text-emerald-600 transition-colors flex items-center gap-4">
                                <Lock className="text-[#3D0448]" size={28}/> 3. Military-Grade Security
                            </h2>
                        ...
                        <div className="w-full md:w-1/4 flex justify-end">
                            <div className="w-24 h-24 bg-[#3D0448]/10 rounded-full flex items-center justify-center border-[8px] border-[#3D0448]/20 group-hover:border-[#3D0448]/30 transition-colors">
                                <Shield size={32} className="text-[#3D0448]" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-20 bg-gray-900 rounded-[2.5rem] p-8 md:p-12 border border-gray-800 text-center relative overflow-hidden group hover:shadow-[0_20px_50px_rgba(79,70,229,0.3)] transition-all duration-500">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#3D0448] via-[#B564C3] to-[#3D0448]"></div>
