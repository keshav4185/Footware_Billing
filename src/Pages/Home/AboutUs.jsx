        ...
        <div className="min-h-screen bg-white font-inter overflow-hidden">
            ...
            <section className="relative pt-32 pb-24 px-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#3D0448]/10 text-[#3D0448] rounded-full text-xs font-black uppercase tracking-widest mb-8 animate-fadeIn">
            ...
            <section className="py-24 px-6 bg-gray-50/50">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="space-y-4">
                                {['Zero Configuration Start', 'Enterprise Grade Security', 'Real-time Dashboards'].map((item, idx) => (
                                    <div key={idx} className="flex items-center gap-3 text-gray-900 font-bold">
                                        <div className="w-6 h-6 bg-[#3D0448]/10 text-[#3D0448] rounded-full flex items-center justify-center">
                    ...
                    <div>
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#B564C3]/10 text-[#B564C3] rounded-full text-[10px] font-black uppercase tracking-widest mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            <div>
                                <h4 className="text-4xl font-black text-[#3D0448] mb-1">10k+</h4>
                                <p className="text-xs font-black text-gray-400 uppercase tracking-widest">Active Users</p>
                            </div>
                            <div>
                                <h4 className="text-4xl font-black text-[#B564C3] mb-1">99.9%</h4>
            ...
            {/* Timeline Section */}
            <section className="max-w-4xl mx-auto py-24 px-6 md:px-16 bg-[#3D0448] relative overflow-hidden sm:mx-6 lg:mx-auto rounded-[4rem] mb-24 shadow-2xl shadow-[#3D0448]/20">
