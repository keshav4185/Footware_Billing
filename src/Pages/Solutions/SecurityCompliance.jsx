...
const SecurityCompliance = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="text-left">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 text-teal-600 text-[10px] font-black uppercase tracking-widest mb-6 shadow-sm">
                                <Shield size={12} />
                                <span>Zero-Trust Architecture</span>
                            </div>
                            <h1 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 leading-tight">
                                Your Data. <span className="text-teal-600">Safe & Secure</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link to="/Signin" className="bg-teal-600 text-white px-10 py-5 rounded-2xl font-black text-lg hover:bg-teal-700 transition-all shadow-xl shadow-teal-100 flex items-center justify-center gap-2">
                        ...
                        <div className="relative">
                            <div className="bg-white border border-gray-100 p-10 rounded-[4rem] shadow-2xl relative z-10 overflow-hidden">
                                <div className="absolute top-0 right-0 p-8 opacity-5">
                                    <Database size={200} className="text-teal-600" />
                                </div>
                                <div className="space-y-8 relative z-10">
                                    ...
                                    <div className="bg-teal-50 p-4 rounded-2xl text-center">
                                        <div className="text-[10px] font-black text-teal-600 uppercase tracking-widest mb-1">Status</div>
                                        <div className="font-black text-teal-800">100% PROTECTED</div>
                                    </div>
                                </div>
                            </div>
                            <div className="absolute inset-0 bg-teal-400 blur-[100px] opacity-10 pointer-events-none rounded-full"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-teal-50/20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div>
                            <h2 className="text-4xl font-black text-gray-900 mb-8 leading-tight text-teal-600">Reliability You Can Count On</h2>
                            ...
                            <div className="space-y-4">
                                {['End-to-end data encryption', '99.9% Up-time guarantee', 'Real-time sync across devices'].map((text, i) => (
                                    <div key={i} className="flex gap-4 items-center font-bold text-gray-800">
                                        <div className="text-teal-600"><CheckCircle2 size={24}/></div>
                                        {text}
                                    </div>
                                ))}
                            </div>
            ...
            {/* Final CTA */}
            <section className="py-24 bg-teal-700 text-center relative overflow-hidden mx-6 rounded-[3rem] mb-24">
                <div className="relative z-10 px-6 text-white">
                    <h2 className="text-3xl md:text-5xl font-black mb-8">Secure Your Business <br/>Today</h2>
                    <Link to="/Signin" className="bg-white text-teal-700 px-12 py-5 rounded-2xl font-black text-lg hover:scale-105 transition-transform shadow-2xl inline-block">
                        Get Secure Access
                    </Link>
                </div>
            </section>
